...
(async()=>{
  ...
  // Решение владельца (сентябрь 2026): поднятый вес становится рабочим сразу,
  // даже при недоборе низа; вернуть его назад — забота maybeRegress
  chk(single.рабочий===60,'12. поднятый вес сразу становится рабочим',
