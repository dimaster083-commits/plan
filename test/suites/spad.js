...
(async()=>{
  ...
  // Пересмотр правил (сентябрь 2026): 60×3/3/2 при плане 6–8 — недобор низа,
  // рабочим такой вес не становится, иначе следующая тренировка начнётся с провала
  chk(single.рабочий===50,'12. вес с недобором низа рабочим не становится',
